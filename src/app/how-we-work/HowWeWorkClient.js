// file: app/how-we-work/HowWeWorkClient.js
"use client";
...
export default function HowWeWorkClient() {
  ...
  // NOTE: Cursor Glow logic aur useRef yahan se hata diya gaya hai kyunki wo layout.js mein hai.
  ...
  return (
    <>
      {/* <main> tag updated: hardcoded colors removed to inherit from layout.js */}
      <main className="relative w-full z-10 overflow-x-hidden pb-10 transition-colors duration-300">
