...
export function GrowthClient() {
  ...
  const [formData, setFormData] = useState({
    ...
    model: "Growth", // Fixed for this VIP page
    experience: "Expert", 
    skills: [], 
    message: "",
    portfolio: ""
  ...
  // High-level skills for agency/strategy partners
  const availableSkills = ["Agency Scaling", "Fractional CMO", "Enterprise B2B Sales", "Full-Stack Marketing", "Tech Architecture", "Strategic Partnerships", "Other"];
    ...
    try {
      const response = await fetch("https://api.web3forms.com/submit", {
        ...
        body: JSON.stringify({
          ...
          subject: "👑 VIP: New GROWTH Partner Application",
          from_name: "Partner Ecosystem",
          Name: formData.fullName,
          Email: formData.email,
          Phone: formData.phone,
          City: formData.city,
          "Agency/Title": formData.profession,
          "Selected Model": formData.model,
          Experience: formData.experience,
          "Leadership Skills": formData.skills.join(", ") || "None selected",
          "Agency/LinkedIn": formData.portfolio || "Not provided",
      ...
      if (result.success) {
        // Success Action 1: Brand Blue Confetti
        confetti({ particleCount: 500, spread: 160, origin: { y: 0.6 }, colors: ['#0097B2', '#ffffff'] });
        setIsSuccess(true);

        // Success Action 2: Prepare WhatsApp Message
        const waMessage = `Hi SM NextGen Team! I want to join as a *GROWTH PARTNER* 👑\n\n*Name:* ${formData.fullName}\n*Role/Agency:* ${formData.profession}\n*Strategy Skills:* ${formData.skills.join(", ") || "N/A"}\n\nI'm looking to maximize revenue share and build a strategic alliance.`;
  ...
  const faqData = [
    { q: "How is a Growth Partner different from a Referral Partner?", a: "A Referral Partner only brings the lead and steps away. A Growth Partner brings the lead AND acts as the high-level strategist or co-executor for the project, allowing them to capture a much larger piece of the revenue." },
    { q: "Can I white-label SM NextGen's services?", a: "Yes. If you run an agency, you can sell our Web Development, AI Automation, or specialized Marketing services under your own brand, and we will execute them seamlessly in the background." },
    { q: "How do payouts work for Growth Partners?", a: "Because you are heavily involved in the strategy and client management, your payouts are structured as a revenue split (usually 30% to 60%) based on the specific services you handle vs. what we execute." },
    { q: "Who makes the ideal Growth Partner?", a: "Fractional CMOs, existing Agency Owners who want to offer more services without hiring, and high-level strategists who have clients but lack a full execution team." }
  ];
    ...
    <>
      <main className="bg-[#F8FAFC] dark:bg-[#0B2545] font-body text-[#0B2545] dark:text-[#E6EEF2] min-h-screen selection:bg-[#0097B2] selection:text-white w-full overflow-x-hidden transition-colors duration-300 relative">
        ...
        <section className="relative pt-32 pb-16 md:pt-40 md:pb-20 bg-[#071A30] text-center px-4 z-10 overflow-hidden border-b border-white/5">
          ...
          <div className="relative z-10 max-w-4xl mx-auto flex flex-col items-center">
            ...
            <span className="inline-block px-4 py-1.5 rounded-full bg-white/10 border border-white/20 text-xs font-bold uppercase tracking-widest text-[#0097B2] mb-6 backdrop-blur-md shadow-sm">
              <i className="fas fa-chess-king mr-2"></i> The Leadership Role
            </span>
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-heading font-extrabold text-white mb-6 leading-tight tracking-tight drop-shadow-sm">
              Become a <span className="text-[#0097B2]">Growth Partner</span>
            </h1>

            {/* Subtext */}
            <p className="text-base md:text-xl text-[#E6EEF2]/90 mb-10 leading-relaxed font-light max-w-2xl">
              The ultimate collaboration. Bring clients, lead the strategy, co-execute alongside our team, and maximize your revenue share. Built for agency owners and strategists.
            </p>
            ...
            <div className="grid lg:grid-cols-2 gap-10 md:gap-16 items-start">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-[#E6EEF2]/70 mb-8 leading-relaxed">
                  As a Growth Partner, you operate as a Fractional Leader. You leverage our entire talent ecosystem to scale your own clients or joint ventures.
                </p>
                <div className="space-y-4">
                  <div className="bg-[#F8FAFC] dark:bg-[#11325B] p-5 rounded-2xl border border-gray-100 dark:border-white/5 flex gap-4 items-start">
                    <i className="fas fa-bullseye text-[#0097B2] text-xl mt-1"></i>
                    <div>
                      <h4 className="font-bold text-[#0B2545] dark:text-white mb-1">Identify & Close</h4>
                      <p className="text-sm text-gray-500 dark:text-[#E6EEF2]/70">Bring in clients from your network. You own the relationship, do the closing, and manage the high-level strategy.</p>
                    </div>
                  </div>
                  <div className="bg-[#F8FAFC] dark:bg-[#11325B] p-5 rounded-2xl border border-gray-100 dark:border-white/5 flex gap-4 items-start">
                    <i className="fas fa-project-diagram text-[#0097B2] text-xl mt-1"></i>
                    <div>
                      <h4 className="font-bold text-[#0B2545] dark:text-white mb-1">Co-Execute</h4>
                      <p className="text-sm text-gray-500 dark:text-[#E6EEF2]/70">Handle the parts of the project you excel at (e.g., Marketing Strategy), and delegate the rest (e.g., Web Dev, Legal, AI) to our team.</p>
                    </div>
                  </div>
                  <div className="bg-[#F8FAFC] dark:bg-[#11325B] p-5 rounded-2xl border border-gray-100 dark:border-white/5 flex gap-4 items-start">
                    <i className="fas fa-chart-line text-[#0097B2] text-xl mt-1"></i>
                    <div>
                      <h4 className="font-bold text-[#0B2545] dark:text-white mb-1">Scale Rapidly</h4>
                      <p className="text-sm text-gray-500 dark:text-[#E6EEF2]/70">Say "Yes" to bigger, more complex projects because you now have an entire agency's workforce backing you up.</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div>
                <div className="bg-[#0B2545] p-8 md:p-10 rounded-[2.5rem] border-2 border-[#0097B2] shadow-[0_20px_50px_rgba(0,151,178,0.2)] relative overflow-hidden text-white">
                  ...
                  <h2 className="text-3xl md:text-4xl font-heading font-extrabold mb-6">Highest Revenue Share</h2>
                  
                  <div className="bg-white/5 border border-white/10 rounded-2xl p-6 mb-6 backdrop-blur-sm">
                    <p className="text-4xl font-black text-green-400 mb-2">30% – 60%+</p>
                    <p className="text-sm text-[#E6EEF2]/80">Of the total project value, depending on your execution share.</p>
                  </div>

                  <h4 className="font-bold mb-4">Ecosystem Example:</h4>
                  <ul className="space-y-3 text-sm text-[#E6EEF2]/90 mb-8">
                    <li className="flex justify-between border-b border-white/10 pb-2">
                      <span>You close a Full-Scale Digital Project:</span>
                    ...
                    <li className="text-[11px] md:text-xs text-[#E6EEF2]/60 pt-2 italic">
                      * Example: You bring a ₹1L deal. You take 15% referral fee (₹15k) + you handle the Ads Execution taking a major cut of the Ads budget. We handle the complex Web Dev & AI integrations. Everyone wins.
                    </li>
                  </ul>
                </div>
              </div>
        ...
        <section className="py-16 md:py-24 bg-[#F8FAFC] dark:bg-[#0B1120] border-b border-gray-100 dark:border-white/5 relative z-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-10 md:mb-16">
              ...
              <p className="text-gray-600 dark:text-[#E6EEF2]/70">The Growth Model is built for leaders who want to scale without overhead.</p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8 md:gap-12">
              ...
              <div className="bg-white dark:bg-[#162032] p-8 md:p-10 rounded-[2.5rem] shadow-sm border border-gray-100 dark:border-white/5">
                ...
                <ul className="space-y-4">
                  <li className="flex items-center gap-4 text-gray-600 dark:text-[#E6EEF2]/80 font-medium">
                    ...
                    Agency Owners wanting to offer more services
                  </li>
                  <li className="flex items-center gap-4 text-gray-600 dark:text-[#E6EEF2]/80 font-medium">
                    <div className="w-10 h-10 rounded-full bg-[#0097B2]/10 text-[#0097B2] flex items-center justify-center shrink-0"><i className="fas fa-chart-pie"></i></div>
                    Fractional CMOs needing an execution arm
                  </li>
                  <li className="flex items-center gap-4 text-gray-600 dark:text-[#E6EEF2]/80 font-medium">
                    <div className="w-10 h-10 rounded-full bg-[#0097B2]/10 text-[#0097B2] flex items-center justify-center shrink-0"><i className="fas fa-chess-knight"></i></div>
                    High-level Business Strategists
                  </li>
                  <li className="flex items-center gap-4 text-gray-600 dark:text-[#E6EEF2]/80 font-medium">
                    <div className="w-10 h-10 rounded-full bg-[#0097B2]/10 text-[#0097B2] flex items-center justify-center shrink-0"><i className="fas fa-handshake"></i></div>
                    Freelancers ready to build their own agency
                  </li>
                </ul>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="bg-white dark:bg-[#162032] p-6 rounded-3xl border border-gray-100 dark:border-white/5 shadow-sm hover:border-[#0097B2] transition-colors">
                  <i className="fas fa-user-minus text-2xl text-[#0097B2] mb-3"></i>
                  <h4 className="font-bold text-[#0B2545] dark:text-white mb-1">Zero Hiring</h4>
                  <p className="text-xs text-gray-500 dark:text-[#E6EEF2]/60">Scale capacity without payroll risks.</p>
                </div>
                <div className="bg-white dark:bg-[#162032] p-6 rounded-3xl border border-gray-100 dark:border-white/5 shadow-sm hover:border-[#0097B2] transition-colors">
                  <i className="fas fa-layer-group text-2xl text-[#0097B2] mb-3"></i>
                  <h4 className="font-bold text-[#0B2545] dark:text-white mb-1">Offer Anything</h4>
                  <p className="text-xs text-gray-500 dark:text-[#E6EEF2]/60">Say yes to Dev, AI, and Marketing.</p>
                </div>
                <div className="bg-white dark:bg-[#162032] p-6 rounded-3xl border border-gray-100 dark:border-white/5 shadow-sm hover:border-[#0097B2] transition-colors">
                  <i className="fas fa-crown text-2xl text-[#0097B2] mb-3"></i>
                  <h4 className="font-bold text-[#0B2545] dark:text-white mb-1">White-Label</h4>
                  <p className="text-xs text-gray-500 dark:text-[#E6EEF2]/60">Sell our services under your brand.</p>
                </div>
                <div className="bg-white dark:bg-[#162032] p-6 rounded-3xl border border-gray-100 dark:border-white/5 shadow-sm hover:border-[#0097B2] transition-colors">
                  <i className="fas fa-money-bill-wave text-2xl text-[#0097B2] mb-3"></i>
                  <h4 className="font-bold text-[#0B2545] dark:text-white mb-1">Max Revenue</h4>
                  <p className="text-xs text-gray-500 dark:text-[#E6EEF2]/60">Capture the largest share of the deal.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section id="partnerForm" className="py-16 md:py-24 bg-white dark:bg-[#071A30] border-t border-gray-200 dark:border-white/5 relative z-20">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center mb-10">
              <span className="inline-block px-4 py-1 rounded-full bg-green-100 text-green-700 dark:bg-green-500/10 dark:text-green-400 text-xs font-bold uppercase tracking-widest mb-4">Strategic Alliance</span>
              <h2 className="text-3xl md:text-5xl font-heading font-extrabold text-[#0B2545] dark:text-white mb-4">Apply as a Growth Partner</h2>
            </div>
            ...
            <div className="bg-[#F8FAFC] dark:bg-[#11325B] p-6 sm:p-10 rounded-[2rem] border border-gray-200 dark:border-white/10 shadow-xl relative overflow-hidden">
              {!isSuccess ? (
                <div>
                  <div className="flex items-center justify-between mb-8">
                    ...
                    <div className="flex items-center gap-2 md:gap-3">
                      ...
                      <span className={`text-[10px] md:text-xs font-bold uppercase tracking-wider ${formStep === 2 ? 'text-[#0B2545] dark:text-white' : 'text-gray-400'}`}>Strategy & Assets</span>
                    </div>
                  </div>
                  ...
                  <form onSubmit={handleSubmit}>
                    ...
                    {formStep === 1 && (
                      <div className="space-y-5 md:space-y-6 animate-fade-in-up">
                        ...
                        <div>
                          <label className="block text-[10px] font-bold text-gray-500 dark:text-[#E6EEF2]/60 uppercase tracking-widest mb-2">Agency Name or Title *</label>
                          <input type="text" name="profession" value={formData.profession} onChange={handleChange} required placeholder="e.g. CEO @ Tech Agency" className="w-full bg-white dark:bg-[#071A30] border border-gray-200 dark:border-white/10 rounded-xl px-4 py-3 md:py-3.5 text-sm text-[#0B2545] dark:text-white focus:border-[#0097B2] outline-none" />
                        </div>
                    ...
                    {formStep === 2 && (
                      <div className="space-y-5 md:space-y-6 animate-fade-in-up">
                        ...
                        <div>
                          <label className="block text-[10px] font-bold text-gray-500 dark:text-[#E6EEF2]/60 uppercase tracking-widest mb-3">Your Strategic Capabilities (Select Multiple)</label>
                        ...
                        <div>
                          <label className="block text-[10px] font-bold text-gray-500 dark:text-[#E6EEF2]/60 uppercase tracking-widest mb-2">Agency Website / LinkedIn URL *</label>
                          <input type="url" name="portfolio" value={formData.portfolio} onChange={handleChange} required placeholder="https://" className="w-full bg-white dark:bg-[#071A30] border border-gray-200 dark:border-white/10 rounded-xl px-4 py-3 md:py-3.5 text-sm text-[#0B2545] dark:text-white focus:border-[#0097B2] outline-none" />
                        </div>

                        <div>
                          <label className="block text-[10px] font-bold text-gray-500 dark:text-[#E6EEF2]/60 uppercase tracking-widest mb-2">Current bottlenecks or goals? (Optional)</label>
                ...
                <div className="flex flex-col justify-center items-center text-center py-12 animate-fade-in-up">
                  ...
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0B2545] dark:text-white mb-3">VIP Application Received! 🎉</h3>
                  <p className="text-gray-500 dark:text-[#E6EEF2]/80 text-sm mb-8 max-w-sm mx-auto">Redirecting you to our WhatsApp to connect with our leadership...</p>
        ...
        <section className="py-16 md:py-24 bg-white dark:bg-[#071A30] transition-colors duration-300 border-t border-gray-200 dark:border-white/5 relative z-20">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-10 md:mb-16">
               <h2 className="text-3xl md:text-4xl font-heading font-extrabold text-[#0B2545] dark:text-white mb-4">Growth Partner FAQs</h2>
            </div>
